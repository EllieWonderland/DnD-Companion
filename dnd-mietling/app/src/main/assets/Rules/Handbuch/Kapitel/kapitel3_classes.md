...
Die folgende Tabelle gibt einen schnellen mechanischen Überblick über die 12 Grundklassen. Sie zeigt, welches Attribut für die Klasse am wichtigsten ist, wie viele Trefferpunkte sie beim Stufenaufstieg generiert und in welchen Bereichen sie geübt (Proficient) ist.

| Klasse | Primäres Attribut | Trefferwürfel | Rettungswürfe | Waffen-Übung | Rüstungs-Übung |
| --- | --- | --- | --- | --- | --- |
| **Barbar** | Stärke | W12 | Stärke, Konstitution | Einfache Waffen, Kriegswaffen | Leichte Rüstung, Mittlere Rüstung, Schilde |
| **Barde** | Charisma | W8 | Geschicklichkeit, Charisma | Einfache Waffen | Leichte Rüstung |
| **Kleriker** | Weisheit | W8 | Weisheit, Charisma | Einfache Waffen | Leichte Rüstung, Mittlere Rüstung, Schilde |
| **Druide** | Weisheit | W8 | Intelligenz, Weisheit | Einfache Waffen | Leichte Rüstung, Schilde |
| **Kämpfer** | Stärke oder Geschicklichkeit | W10 | Stärke, Konstitution | Einfache Waffen, Kriegswaffen | Leichte, Mittlere, Schwere Rüstung, Schilde |
| **Mönch** | Geschicklichkeit & Weisheit | W8 | Stärke, Geschicklichkeit | Einfache Waffen, Kriegswaffen mit Eigenschaft *Leicht* | Keine |
| **Paladin** | Stärke & Charisma | W10 | Weisheit, Charisma | Einfache Waffen, Kriegswaffen | Leichte, Mittlere, Schwere Rüstung, Schilde |
| **Waldläufer** | Geschicklichkeit & Weisheit | W10 | Stärke, Geschicklichkeit | Einfache Waffen, Kriegswaffen | Leichte Rüstung, Mittlere Rüstung, Schilde |
| **Schurke** | Geschicklichkeit | W8 | Geschicklichkeit, Intelligenz | Einfache Waffen, Kriegswaffen mit *Finesse* oder *Leicht* | Leichte Rüstung |
| **Zauberer (Sorcerer)** | Charisma | W6 | Konstitution, Charisma | Einfache Waffen | Keine |
| **Hexenmeister (Warlock)** | Charisma | W8 | Weisheit, Charisma | Einfache Waffen | Leichte Rüstung |
| **Magier (Wizard)** | Intelligenz | W6 | Intelligenz, Weisheit | Einfache Waffen | Keine |

---

### Unterklassen

Jede Klasse wählt auf Stufe 3 eine Spezialisierung. Hier sind die mechanisch gültigen Optionen nach dem *Player's Handbook 2024*:
...
* **Barde:**
  * Schule des Tanzes (College of Dance)
  * Schule des Glamours (College of Glamour)
  * Schule des Wissens (College of Lore)
  * Schule der Tapferkeit (College of Valor)

* **Kleriker:**
  * Domäne des Lebens (Life Domain)
  * Domäne des Lichts (Light Domain)
  * Domäne der List (Trickery Domain)
  * Domäne des Krieges (War Domain)

* **Druide:**
  * Zirkel des Landes (Circle of the Land)
  * Zirkel des Mondes (Circle of the Moon)
  * Zirkel des Meeres (Circle of the Sea)
  * Zirkel der Sterne (Circle of the Stars)

* **Kämpfer:**
  * Kampfmeister (Battle Master)
  * Champion
  * Mystischer Ritter (Eldritch Knight)
  * Psi-Krieger (Psi Warrior)

* **Mönch:**
  * Krieger der Barmherzigkeit (Warrior of Mercy)
...
* **Schurke:**
  * Arkaner Trickbetrüger (Arcane Trickster)
  * Meuchelmörder (Assassin)
  * Seelenklinge (Soulknife)
  * Dieb (Thief)

* **Zauberer (Sorcerer):**
  * Aberrante Zauberei (Aberrant Sorcery)
  * Uhrwerk-Zauberei (Clockwork Sorcery)
  * Drakonische Zauberei (Draconic Sorcery)
...
* **Magier (Wizard):**
  ...
  * Erkenntnismagier (Diviner)
  * Hervorrufer (Evoker)
  * Illusionsmagier (Illusionist)
...
* **Trefferwürfel:** W12 pro Barbaren-Stufe
* **Rettungswürfe:** Stärke, Konstitution
* **Fertigkeiten (Wähle 2):** Athletik, Einschüchtern, Mit Tieren umgehen, Naturkunde, Überleben oder Wahrnehmung
* **Waffen-Übung:** Einfache Waffen, Kriegswaffen
* **Rüstungs-Übung:** Leichte Rüstung, Mittelschwere Rüstung, Schilde
* **Startausrüstung:** Wähle A oder B: (A) Zweihandaxt, 4 Handäxte, Entdeckerausrüstung und 15 GM; oder (B) 75 GM

### Klassenmerkmale
* **Stufe 1: Kampfrausch (Rage):** Als Bonusaktion für 10 Minuten aktivierbar. Gewährt Vorteil auf Stärke-Würfe/-Rettungswürfe, Bonus-Schaden bei Stärke-Nahkampfangriffen und Resistenz gegen Wucht-, Stich- und Hiebschaden. Kann verlängert werden, indem du angreifst, Gegner zu einem Rettungswurf zwingst oder eine Bonusaktion opferst.
* **Stufe 1: Ungepanzerte Verteidigung:** Ohne Rüstung ist deine RK = 10 + Geschicklichkeits-Modifikator + Konstitutions-Modifikator (Schild erlaubt).
* **Stufe 1: Waffenmeisterschaft (Weapon Mastery):** Du kannst die Meisterschafts-Eigenschaften von 2 Nahkampfwaffen nutzen (austauschbar nach Langer Rast).
* **Stufe 2: Gefahreninstinkt (Danger Sense):** Du hast Vorteil auf Geschicklichkeits-Rettungswürfe gegen Effekte, die du sehen kannst.
* **Stufe 2: Rücksichtsloser Angriff (Reckless Attack):** Du kannst bei deinem ersten Angriff im Zug entscheiden, rücksichtslos anzugreifen. Dies gibt dir bis zum Ende deines Zuges Vorteil auf alle Stärke-Angriffswürfe, aber Angriffe gegen dich haben ebenfalls Vorteil bis zu deinem nächsten Zug.
...
* **Stufe 18: Unbezwingbare Macht (Indomitable Might):** Jeder Stärke-Wurf, dessen Gesamtwert unter deinem Stärke-Wert (nicht Modifikator) liegt, kann als dein Stärke-Wert behandelt werden.
* **Stufe 20: Ursprünglicher Champion (Primal Champion):** Stärke und Konstitution steigen um 4. Das Maximum für beide Werte ist nun 25.

## Unterklassen des Barbaren (Barbarian)
...
* **Trefferwürfel:** W8 pro Barden-Stufe
* **Rettungswürfe:** Geschicklichkeit, Charisma
* **Fertigkeiten:** Wähle 3 beliebige Fertigkeiten
...
### Schule des Tanzes (College of Dance)
* **Stufe 3: Ungepanzerte Verteidigung:** Ohne Rüstung (und Schild) ist deine RK = 10 + GES-Modifikator + CHA-Modifikator.
...
### Schule der Tapferkeit (College of Valor)
* **Stufe 3: Kampftraining (Martial Training):** Übung in Kriegswaffen, Mittlerer Rüstung und Schilden. Deine Waffen können als Zauberfokus dienen.
* **Stufe 3: Kampfinspiration (Combat Inspiration):** Verbündete können den Inspirationwürfel nutzen, um ihn zu einem Angriffswurf ODER einem Schadenswurf zu addieren. Alternativ können sie ihn als Reaktion auf ihre RK addieren, wenn sie angegriffen werden.
* **Stufe 6: Extra-Angriff (Extra Attack):** Du kannst 2x angreifen. Du darfst einen der Angriffe durch das Wirken eines Zaubertricks ersetzen.
* **Stufe 14: Kampfmagie (Battle Magic):** Wenn du einen Zauber wirkst (mit Aktionszeit 1 Aktion), kannst du als Bonusaktion einen Nah- oder Fernkampfangriff ausführen.
...
### Kernmerkmale
* **Primäre Attribute:** Stärke oder Geschicklichkeit
* **Trefferwürfel:** W10 pro Kämpfer-Stufe
* **Rettungswürfe:** Stärke, Konstitution
* **Fertigkeiten (Wähle 2):** Akrobatik, Athletik, Einschüchtern, Geschichte, Mit Tieren umgehen, Motiv erkennen, Überleben oder Wahrnehmung
* **Waffen-Übung:** Einfache Waffen, Kriegswaffen
* **Rüstungs-Übung:** Leichte, Mittlere und Schwere Rüstung, Schilde
* **Startausrüstung:** Wähle A oder B: (A) Kettenhemd, Langschwert, 2 Handäxte, Entdeckerausrüstung und 8 GM; oder (B) 155 GM

### Klassenmerkmale
* **Stufe 1: Kampfstil (Fighting Style):** Wähle ein Kampfstil-Talent.
* **Stufe 1: Durchschnaufen (Second Wind):** Als Bonusaktion heilst du dich um 1W10 + deine Kämpfer-Stufe. Du hast 2 Nutzungen (skaliert später). Bei einer Kurzen Rast erhältst du 1 Nutzung zurück, bei einer Langen alle.
* **Stufe 1: Waffenmeisterschaft (Weapon Mastery):** Du kannst die Meisterschafts-Eigenschaften von 3 Waffen nutzen (austauschbar nach Langer Rast).
* **Stufe 2: Aktionswoge (Action Surge):** 1x pro Rast kannst du in deinem Zug eine zusätzliche Aktion ausführen (Ausnahme: Diese Aktion darf nicht die Magische Aktion / Zaubern sein).
* **Stufe 2: Taktischer Verstand (Tactical Mind):** Wenn du einen Attributswurf nicht bestehst, kannst du eine Nutzung *Durchschnaufen* ausgeben und 1W10 zum Resultat addieren. Schlägt der Wurf trotzdem fehl, wird die Nutzung nicht verbraucht.
* **Stufe 3: Kämpfer-Unterklasse:** Wähle einen Kampf-Archetyp.
* **Stufe 5: Extra-Angriff (Extra Attack):** Du greifst zweimal an. (Dreimal ab Stufe 11, viermal ab Stufe 20).
* **Stufe 9: Taktische Verschiebung (Tactical Shift):** Immer wenn du *Durchschnaufen* aktivierst, kannst du dich sofort bis zur Hälfte deiner Bewegungsrate bewegen (ohne Gelegenheitsangriffe zu provozieren).
* **Stufe 9: Unbezwingbar (Indomitable):** Wenn du einen Rettungswurf nicht bestehst, darfst du ihn neu würfeln (musst das neue Ergebnis nehmen) und addierst deine Kämpfer-Stufe. 1x pro Langer Rast. (2x ab Stufe 15, 3x ab Stufe 17).
* **Stufe 13: Studierte Angriffe (Studied Attacks):** Wenn du mit einem Waffenangriff verfehlst, hast du auf deinen nächsten Angriffswurf gegen dasselbe Ziel bis zum Ende deines nächsten Zuges Vorteil.

## Unterklassen des Kämpfers (Fighter)

### Kampfmeister (Battle Master)
* **Stufe 3: Überlegenheit im Kampf (Combat Superiority):** Du lernst 3 Manöver deiner Wahl. Du erhältst 4 Überlegenheitswürfel (Stufe 3 = W8). Sie regenerieren sich nach einer Kurzen/Langen Rast.
* **Stufe 3: Schüler des Krieges (Student of War):** Übung in einem Handwerkszeug (Artisan's Tools).
* **Stufe 7: Kenne deinen Feind (Know Your Enemy):** Als Bonusaktion analysierst du eine Kreatur (Immun gegen Täuschungen bzgl. der Analyse). Du erfährst Resistenzen, Verwundbarkeiten und Immunitäten (Schaden + Zustände). 1x pro Langer Rast. (Zusätzliche Nutzung für 1 Überlegenheitswürfel). Du erlernst 2 weitere Manöver und bekommst 1 weiteren Überlegenheitswürfel.
* **Stufe 10: Verbesserte Überlegenheit:** Die Überlegenheitswürfel werden zu W10.
* **Stufe 15: Unerbittlich (Relentless):** 1x pro Zug, wenn du keine Würfel mehr hast und Initiative würfelst oder ein Manöver einsetzt, kannst du einen W8 rollen und diesen anstelle deines regulären Überlegenheitswürfels nutzen, ohne einen aus dem Pool zu verbrauchen. Du erlernst 2 weitere Manöver und bekommst 1 weiteren Überlegenheitswürfel (Gesamt: 6).
* **Stufe 18: Ultimative Überlegenheit:** Die Überlegenheitswürfel werden zu W12.

### Champion
* **Stufe 3: Verbesserter Kritischer Treffer (Improved Critical):** Waffen- und Unbewaffnete Angriffe sind bei einer natürlichen 19 oder 20 kritisch.
* **Stufe 3: Bemerkenswerter Athlet (Remarkable Athlete):** Du erhältst Vorteil auf Initiative-Würfe und auf alle Stärke-(Athletik)-Würfe. Wenn du Weitsprung machst, springst du (STR-Mod) Fuß weiter.
* **Stufe 7: Zusätzlicher Kampfstil (Additional Fighting Style):** Wähle ein weiteres Kampfstil-Talent.
* **Stufe 10: Heldenhafter Krieger (Heroic Warrior):** Wenn du deinen Zug im Kampf startest und keine Heldenhafte Inspiration hast, erhältst du 1 Heldenhafte Inspiration.
* **Stufe 15: Überlegener Kritischer Treffer (Superior Critical):** Deine Angriffe sind bei einer 18, 19 oder 20 kritisch.
* **Stufe 18: Überlebenskünstler (Survivor):** Wenn du zu Beginn deines Zuges weniger als die Hälfte deiner maximalen TP hast, regenerierst du (5 + KON-Mod) TP. Funktioniert nicht bei 0 TP. Zudem hast du Vorteil auf Todesrettungswürfe. Bei einer gewürfelten 18, 19 oder 20 beim Todesrettungswurf wachst du mit 1 TP wieder auf.

### Mystischer Ritter (Eldritch Knight)
* **Stufe 3: Zauberwirken (Spellcasting):** Du lernst Zauber aus der Magier-Liste (Abjuration, Evocation etc. Beschränkungen gibt es 2024 nicht mehr, es ist die komplette Magier-Liste). Zauberattribut: Intelligenz. Fokus: Ein Arkaner Fokus.
...
### Kernmerkmale
* **Primäre Attribute:** Geschicklichkeit und Weisheit
* **Trefferwürfel:** W8 pro Mönch-Stufe
* **Rettungswürfe:** Stärke, Geschicklichkeit
* **Fertigkeiten (Wähle 2):** Akrobatik, Athletik, Geschichte, Heimlichkeit, Motiv erkennen oder Religion
* **Waffen-Übung:** Einfache Waffen, Kriegswaffen mit der Eigenschaft *Leicht*
* **Rüstungs-Übung:** Keine
* **Startausrüstung:** Wähle A oder B: (A) Speer, 5 Wurfpfeile (Darts), Handwerker-Werkzeug oder Musikinstrument, Entdeckerausrüstung und 9 GM; oder (B) 50 GM

### Klassenmerkmale
* **Stufe 1: Kampfkunst (Martial Arts):** Dein unbewaffneter Schlag verursacht 1W6 Schaden (skaliert auf 1W8 auf Stufe 5, 1W10 auf Stufe 11, 1W12 auf Stufe 17). Du kannst GES statt STR nutzen. Wenn du die Angriffsaktion ausführst, kannst du als Bonusaktion unbewaffnet angreifen.
* **Stufe 1: Ungepanzerte Verteidigung:** Ohne Rüstung und Schild ist deine RK = 10 + GES-Modifikator + WEI-Modifikator.
* **Stufe 2: Fokus des Mönchs (Monk's Focus):** Du hast Fokus-Punkte in Höhe deiner Mönchsstufe (regeneration bei Kurzer/Langer Rast). Du kannst sie für folgende Optionen nutzen:
...
* **Stufe 6: Ermächtigte Schläge (Empowered Strikes):** Deine unbewaffneten Schläge können optional Energieschaden (Force Damage) verursachen.
* **Stufe 7: Entrinnen (Evasion):** Nimm bei geschafftem GES-Rettungswurf gegen Bereichseffekte keinen Schaden, bei fehlgeschlagenem nur halben.
* **Stufe 10: Erhöhter Fokus (Heightened Focus):** Schlaghagel = 3 Schläge. Geduldige Verteidigung = Zusätzlich Temp. TP. Schritt des Windes = Du kannst eine willige Kreatur mitnehmen.
* **Stufe 10: Selbstwiederherstellung (Self-Restoration):** Am Ende deines Zuges kannst du (ohne Aktionskosten) den Zustand Bezaubert, Verängstigt oder Vergiftet beenden. Zusätzlich leidest du nicht an Nahrungs-/Wassermangel.
* **Stufe 13: Energie abwehren (Deflect Energy):** *Angriffe abwehren* funktioniert nun gegen jeden Schadenstyp (außer Psychisch).
* **Stufe 14: Disziplinierter Überlebender (Disciplined Survivor):** Du erhältst Übung in allen Rettungswürfen.
* **Stufe 15: Perfekter Fokus (Perfect Focus):** Wenn du Initiative würfelst und weniger als 3 Fokus-Punkte hast, regenerierst du Fokus bis du genau 3 Punkte hast.
* **Stufe 20: Körper der Erleuchtung (Body of Enlightenment):** GES und WEI steigen um 4. Das Maximum für beide Werte ist nun 25.

## Unterklassen des Mönchs (Monk)

### Krieger der Barmherzigkeit (Warrior of Mercy)
* **Stufe 3: Werkzeuge der Barmherzigkeit (Implements of Mercy):** Übung in Einsicht (Insight), Medizin (Medicine) und Kräuterkunde (Herbalism Kit).
* **Stufe 3: Hand der Heilung (Hand of Healing):** Wenn du eine Angriffsaktion oder *Schlaghagel* ausführst, kannst du einen unbewaffneten Angriff durch eine Heilung auf eine berührte Kreatur austauschen (Heilung = Waffenschadens-Würfel + WEI-Modifikator). Kostet 1 Fokus-Punkt. (Kostenlos, wenn es im *Schlaghagel* getauscht wird, da der Schlaghagel selbst schon Fokus gekostet hat).
* **Stufe 3: Hand des Schadens (Hand of Harm):** Triffst du mit einem unbewaffneten Schlag, kannst du 1 Fokus-Punkt ausgeben, um Nekrotischen Zusatz-Schaden in Höhe deines Waffenschadens-Würfels + WEI-Modifikator zuzufügen (Nur 1x pro Zug).
* **Stufe 6: Berührung des Arztes (Physician's Touch):** *Hand der Heilung* entfernt zusätzlich Blind, Taub, Gelähmt, Vergiftet oder Betäubt. *Hand des Schadens* belegt den Feind bis zum Ende deines nächsten Zuges zusätzlich automatisch mit dem Zustand *Vergiftet* (kein Rettungswurf).
* **Stufe 11: Hagel von Heilung und Schaden (Flurry of Healing and Harm):** Wenn du *Schlaghagel* ausführst, kannst du nun beide Extra-Angriffe kostenlos ersetzen (einen durch *Heilung*, einen durch *Schaden*, oder beides Angriffe lassen etc.).
...
* **Stufe 17: Vibrierende Handfläsche (Quivering Palm):** Triffst du eine Kreatur, kannst du 4 Fokus-Punkte ausgeben. Die Vibrationen bleiben eine Anzahl an Tagen = deiner Mönchsstufe bestehen. Als Magische Aktion kannst du die Vibrationen auslösen: Die Kreatur muss einen KON-Save bestehen (Fehlschlag: Sie erleidet 10W12 + Mönchsstufe Energieschaden / Erfolg: Die Hälfte).
---

## Paladin (Paladin)

### Kernmerkmale
* **Primäre Attribute:** Stärke und Charisma
* **Trefferwürfel:** W10 pro Paladin-Stufe
* **Rettungswürfe:** Weisheit, Charisma
* **Fertigkeiten (Wähle 2):** Athletik, Einschüchtern, Heilkunde, Motiv erkennen, Religion oder Überreden
* **Waffen-Übung:** Einfache Waffen, Kriegswaffen
* **Rüstungs-Übung:** Leichte, Mittlere und Schwere Rüstung, Schilde
* **Startausrüstung:** Wähle A oder B: (A) Kettenhemd, Schild, Langschwert, 6 Speere, Heiliges Symbol, Priesterpaket und 9 GM; oder (B) 150 GM

### Klassenmerkmale
* **Stufe 1: Handauflegen (Lay on Hands):** Pool = Paladinstufe x 5 TP. Du kannst **als Bonusaktion** eine Kreatur berühren und TP aus dem Pool heilen.
* **Stufe 1: Zauberwirken (Spellcasting):** Paladine können nun ab Stufe 1 zaubern. Zauberattribut ist Charisma.
* **Stufe 1: Waffenmeisterschaft (Weapon Mastery):** Übung in 2 Waffenmeisterschaften.
* **Stufe 2: Kampfstil (Fighting Style):** Wähle ein Kampfstil-Talent.
* **Stufe 2: Göttliches Niederstrecken (Divine Smite):** Der Zauber *Divine Smite* ist immer vorbereitet. Er wird nach einem erfolgreichen Treffer als **Bonusaktion** (kostet einen Zauberplatz) gewirkt, um zusätzlichen Gleißenden Schaden zu verursachen.
...
## Unterklassen des Paladins (Paladin)
...
### Kernmerkmale
* **Primäres Attribut:** Geschicklichkeit
* **Trefferwürfel:** W8 pro Schurken-Stufe
* **Rettungswürfe:** Geschicklichkeit, Intelligenz
* **Fertigkeiten (Wähle 4):** Akrobatik, Athletik, Auftreten, Einschüchtern, Fingerfertigkeit, Heimlichkeit, Motiv erkennen, Nachforschen, Täuschen, Überreden oder Wahrnehmung
* **Waffen-Übung:** Einfache Waffen, Kriegswaffen mit der Eigenschaft *Finesse* oder *Leicht*
* **Rüstungs-Übung:** Leichte Rüstung
* **Startausrüstung:** Wähle A oder B: (A) Lederrüstung, 2 Dolche, Kurzschwert, Kurzbogen, 20 Pfeile, Köcher, Diebeswerkzeug, Einbrecherpaket und 8 GM; oder (B) 110 GM
...
* **Stufe 3: Schurken-Unterklasse:** Wähle einen Archetyp.
* **Stufe 5: Listiger Schlag (Cunning Strike):** Wenn du deinen Hinterhältigen Angriff ausführst, kannst du auf einen der Schadenswürfel (1W6) verzichten, um stattdessen einen Zusatzeffekt auszulösen: Das Ziel vergiften (Gift), zu Fall bringen (Stolpern) oder dich wegbewegen ohne einen Gelegenheitsangriff zu provozieren (Rückzug).
* **Stufe 5: Entrinnen (Uncanny Dodge):** Als Reaktion halbierst du den Schaden eines Angriffs, den du sehen kannst.
* **Stufe 7: Verlässliches Talent (Reliable Talent):** Wenn du einen Attributswurf für eine Fertigkeit oder ein Werkzeug machst, in dem du Übung hast, behandelst du einen W20-Wurf von 9 oder niedriger automatisch als eine 10.
* **Stufe 7: Ausweichen (Evasion):** Bei GES-Rettungswürfen für halben Schaden (wie *Feuerball*) nimmst du bei Erfolg keinen Schaden, bei Fehlschlag nur halben.
* **Stufe 11: Verbesserter Listiger Schlag (Improved Cunning Strike):** Du kannst nun auf ZWEI W6 deines Hinterhältigen Angriffs verzichten, um zwei unterschiedliche Effekte des Listigen Schlags gleichzeitig anzuwenden.
* **Stufe 14: Tückische Schläge (Devious Strikes):** Du erhältst noch stärkere Effekte für den *Listigen Schlag* (Kosten: Verzicht auf 2 bis 6 W6): Ziel blenden, betäuben oder sogar K.o. schlagen.
* **Stufe 15: Schlüpfriger Geist (Slippery Mind):** Du erhältst Übung in Weisheits- und Charisma-Rettungswürfen.
* **Stufe 18: Unfassbar (Elusive):** Kein Angriffswurf gegen dich kann im Vorteil sein, solange du nicht Kampfunfähig bist.
* **Stufe 20: Schicksalsschlag (Stroke of Luck):** 1x pro Kurzer/Langer Rast kannst du einen fehlgeschlagenen W20-Wurf nachträglich in eine automatische 20 umwandeln.

## Unterklassen des Schurken (Rogue)
...
* **Stufe 3: Meister der Infiltration (Infiltration Expertise):** Du hast Vorteil auf *Täuschen* (Deception), wenn du vorgibst, jemand anders zu sein. Auch beim Erstellen/Fälschen von Dokumenten und der Annahme von Identitäten.
* **Stufe 9: Vergiftete Waffen (Envenom Weapons):** Nutzt du *Listiger Schlag* (Cunning Strike) mit dem Effekt *Vergiften*, ignorierst du die Gift-Resistenz des Feindes. Wenn das Ziel den Rettungswurf nicht schafft, erleidet es zusätzlich 2W6 Nekrotischen Schaden.
* **Stufe 13: Todesstoß (Death Strike):** Wenn du in der ersten Kampfrunde einen Gegner triffst und *Meucheln* aktivierst, muss das Ziel einen KON-Rettungswurf (SG = 8 + GES-Mod + ÜB) ablegen. Fehlschlag: Der GESAMTE Schaden des Angriffs wird verdoppelt.
...
### Dieb (Thief)
* **Stufe 3: Schnelle Hände (Fast Hands):** Du kannst die Aktion "Einen Gegenstand benutzen" (Use an Object) oder *Fingerfertigkeit* als Bonusaktion (durch *Listige Aktion*) ausführen.
* **Stufe 3: Kletterkünstler (Second-Story Work):** Klettergeschwindigkeit entspricht deiner Laufgeschwindigkeit. Wenn du springst, kannst du deine GES als Berechnungsgrundlage nutzen (statt STR) und addierst deinen GES-Modifikator zu der gewürfelten Distanz.
* **Stufe 9: Ultimativer Schleicher (Supreme Sneak):** Wenn du eine Rüstung trägst, die dir keinen Nachteil auf *Heimlichkeit* gibt, erhältst du automatisch Vorteil auf *Heimlichkeit*, solange du dich in diesem Zug nicht weiter als deine halbe Bewegungsrate bewegst. Du verlierst beim Verstecken auch nicht deinen Versteckt-Zustand, wenn Gegner deinen Ausgangsort passieren.
* **Stufe 13: Magische Gegenstände nutzen (Use Magic Device):** Du ignorierst alle Klassen-, Rassen- und Stufen-Voraussetzungen bei der Nutzung magischer Items. Du kannst 4 Gegenstände einstimmen (statt 3). Zudem kannst du Spruchrollen jeglicher Klasse nutzen (mit INT für Zauberangriff/Rettungswurf).
* **Stufe 17: Reflexe des Diebes (Thief's Reflexes):** Du erhältst im ersten Zug (Runde 1) jedes Kampfes *zwei* komplette Spielzüge. Den zweiten agierst du, nachdem deine eigentliche Initiative-Zahl um 10 verringert wurde.
---
...
* **Trefferwürfel:** W6 pro Magier-Stufe
* **Rettungswürfe:** Intelligenz, Weisheit
* **Fertigkeiten (Wähle 2):** Arkane Kunde, Geschichte, Medizin, Motiv erkennen, Nachforschen oder Religion
* **Waffen-Übung:** Einfache Waffen
* **Rüstungs-Übung:** Keine
* **Startausrüstung:** Wähle A oder B: (A) Kampfstab, Arkaner Fokus (Zauberbuch), Gelehrtenpaket und 5 GM; oder (B) 55 GM

### Klassenmerkmale
* **Stufe 1: Zauberwirken (Spellcasting):** Zauberattribut Intelligenz. Du bereitest Zauber aus deinem Zauberbuch vor.
* **Stufe 1: Arkane Erholung (Arcane Recovery):** 1x pro Tag bei einer Kurzen Rast erhältst du verbrauchte Zauberplätze zurück (Gesamtsumme der Zauberstufen = max. halbe Magierstufe, max. Stufe 5).
* **Stufe 1: Ritualexperte (Ritual Adept):** Du kannst Magier-Zauber mit dem Tag "Ritual" direkt aus deinem Zauberbuch als Ritual wirken, selbst wenn du sie nicht vorbereitet hast.
* **Stufe 2: Gelehrter (Scholar):** Wähle eine der folgenden Fertigkeiten, in der du Übung hast: Arkane Kunde, Geschichte, Naturkunde oder Religion. Du erhältst Expertise (doppelter Übungsbonus) darin.
* **Stufe 3: Magier-Unterklasse:** Wähle eine Zauberschule.
* **Stufe 5: Zauber einprägen (Memorize Spell):** Du kannst 1 Minute studieren, um einen deiner aktuell vorbereiteten Zauber gegen einen anderen Zauber aus deinem Zauberbuch auszutauschen.
* **Stufe 18: Zaubermeisterschaft (Spell Mastery):** Wähle einen Magier-Zauber der 1. Stufe und einen der 2. Stufe aus deinem Zauberbuch (müssen eine Aktionszeit von 1 Aktion oder Bonusaktion haben). Du hast sie immer vorbereitet und kannst sie ohne Zauberplatz auf ihrer Grundstufe beliebig oft wirken. Du kannst die Zauber nach 8 Stunden des Studiums austauschen.
* **Stufe 20: Signaturzauber (Signature Spells):** Wähle zwei Magier-Zauber der 3. Stufe. Sie sind immer vorbereitet. Du kannst jeden der beiden einmalig ohne Zauberplatz (als Stufe-3-Zauber) wirken und erholst diese Aufladungen nach einer Kurzen oder Langen Rast.

## Unterklassen des Magiers (Wizard)
...
* **Stufe 3: Zauber formen (Sculpt Spells):** Wenn du einen Evocation-Zauber (Flächenzauber wie *Feuerball*) wirkst, kannst du in der Wirkungsfläche "sichere Zonen" schaffen. Wähle eine Anzahl an Verbündeten (gleich 1 + Zauberstufe). Sie bestehen ihre Rettungswürfe gegen deinen Zauber automatisch und nehmen absolut keinen Schaden.
* **Stufe 6: Mächtiger Zaubertrick (Potent Cantrip):** Wenn ein Gegner einen Rettungswurf gegen einen deiner Zaubertricks besteht (oder du bei einem Zaubertrick verfehlst, der Angriffswürfe nutzt), nimmt das Ziel immer noch halben Schaden, statt keinen zu nehmen.
* **Stufe 10: Verstärkte Hervorrufung (Empowered Evocation):** Du addierst deinen INT-Modifikator zu einem Schadenswurf eines Evocation-Zaubers. (Die Regel 2024 besagt: Fügt der Zauber auf einer Fläche gleichzeitig Schaden zu, addiere es bei allen Opfern für diesen einen Wurf).
* **Stufe 14: Überladene Magie (Overchannel):** Wirkst du einen Magier-Zauber von Stufe 1 bis 5, der Schaden verursacht, kannst du maximierten Schaden anrichten (du rollst nicht, du nimmst die maximale Augenzahl). Der erste Einsatz nach Langer Rast ist gratis. Jeder erneute Versuch zwingt dich jedoch, dir selbst 2W12 Nekrotischen Schaden (der Resistenzen und Immunitäten ignoriert) pro Zauberstufe zuzufügen.

### Illusionsmagier (Illusionist)
* **Stufe 3: Gelehrter der Illusion (Illusion Savant):** Halbierte Kosten für Illusions-Zauber.
* **Stufe 3: Verbesserte Kleine Illusion (Improved Minor Illusion):** Du lernst den Zaubertrick *Kleine Illusion* (oder einen anderen). Du kannst nun Ton und Bild GLEICHZEITIG in der Aktivierung casten (normalerweise geht nur eins). Zudem kannst du die Illusion auch als Bonusaktion anstatt einer Aktion wirken.
* **Stufe 6: Formbare Illusionen (Malleable Illusions):** Wenn du eine Illusion erschaffen hast (mit einer Dauer ab 1 Minute aufwärts), kannst du eine Bonusaktion (anstatt einer Aktion) nutzen, um das Bild der Illusion oder die Parameter zu verändern, solange du die Illusion noch sehen kannst.
* **Stufe 10: Illusorisches Selbst (Illusory Self):** Als Reaktion, wenn ein Angriffswurf gegen dich trifft, kannst du das Duplikat deines Körpers aktivieren. Der Angriff verfehlt dich automatisch, da er das Duplikat zerstört. (1x pro Kurzer/Langer Rast, danach durch den Einsatz von Zauberplätzen für Stufe 2+ wiederaufladbar).
* **Stufe 14: Illusorische Realität (Illusory Reality):** Wenn du einen Illusionszauber von Stufe 1 oder höher wirkst, kannst du EINEN (nicht-magischen) Gegenstand, der Teil der Illusion ist, für exakt 1 Minute "real" werden lassen (z.B. eine erschaffene Brücke trägt euch nun wirklich). Die Realität kann keinen Schaden anrichten oder jemanden unmittelbar einklemmen/schädigen.

## Kleriker (Cleric)

### Kernmerkmale

* **Primäres Attribut:** Weisheit
* **Trefferwürfel:** W8 pro Klerikerstufe
* **Rettungswürfe:** Weisheit, Charisma
* **Fertigkeiten (Wähle 2):** Geschichte, Motiv erkennen, Heilkunde, Überzeugen oder Religion
* **Waffen-Übung:** Einfache Waffen
* **Rüstungs-Übung:** Leichte Rüstung, Mittlere Rüstung, Schilde
* **Startausrüstung:** Wähle A oder B: (A) Kettenhemd, Schild, Streitkolben, Heiliges Symbol, Priesterpaket und 7 GM; oder (B) 110 GM

### Klassentabelle

| Stufe | ÜB | Merkmale | Zaubertricks | Vorbereitete Zauber | 1. | 2. | 3. | 4. | 5. | 6. | 7. | 8. | 9. |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | +2 | Zauberwirken, Göttlicher Orden (Divine Order) | 3 | 4 | 2 | - | - | - | - | - | - | - | - |
| 2 | +2 | Göttliche Macht fokussieren (2/Rast) | 3 | 5 | 3 | - | - | - | - | - | - | - | - |
| 3 | +2 | Kleriker-Unterklasse | 3 | 6 | 4 | 2 | - | - | - | - | - | - | - |
| 4 | +2 | Attributswertverbesserung | 4 | 7 | 4 | 3 | - | - | - | - | - | - | - |
| 5 | +3 | Untote versengen (Sear Undead) | 4 | 9 | 4 | 3 | 2 | - | - | - | - | - | - |
| 6 | +3 | Unterklassenmerkmal | 4 | 10 | 4 | 3 | 3 | - | - | - | - | - | - |
| 7 | +3 | Gesegnete Schläge (Blessed Strikes) | 4 | 11 | 4 | 3 | 3 | 1 | - | - | - | - | - |
| 8 | +3 | Attributswertverbesserung | 4 | 12 | 4 | 3 | 3 | 2 | - | - | - | - | - |
| 9 | +4 | - | 4 | 14 | 4 | 3 | 3 | 3 | 1 | - | - | - | - |
| 10 | +4 | Göttliche Intervention | 5 | 15 | 4 | 3 | 3 | 3 | 2 | - | - | - | - |
| 11 | +4 | - | 5 | 16 | 4 | 3 | 3 | 3 | 2 | 1 | - | - | - |
| 12 | +4 | Attributswertverbesserung | 5 | 16 | 4 | 3 | 3 | 3 | 2 | 1 | - | - | - |
| 13 | +5 | - | 5 | 17 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | - | - |
| 14 | +5 | Verbesserte Gesegnete Schläge | 5 | 17 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | - | - |
| 15 | +5 | - | 5 | 18 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | - |
| 16 | +5 | Attributswertverbesserung | 5 | 18 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | - |
| 17 | +6 | Unterklassenmerkmal | 5 | 19 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | 1 |
| 18 | +6 | - | 5 | 20 | 4 | 3 | 3 | 3 | 3 | 1 | 1 | 1 | 1 |
| 19 | +6 | Epische Wohltat | 5 | 21 | 4 | 3 | 3 | 3 | 3 | 2 | 1 | 1 | 1 |
| 20 | +6 | Größere Göttliche Intervention | 5 | 22 | 4 | 3 | 3 | 3 | 3 | 2 | 2 | 1 | 1 |

### Klassenmerkmale

**Stufe 1: Zauberwirken (Spellcasting)**

* Du nutzt Weisheit als Zauberattribut und ein Heiliges Symbol als Fokus. Du bereitest nach einer Langen Rast Zauber aus der Klerikerliste vor (Anzahl siehe Tabelle). Du kannst einen vorbereiteten Zauber nach einer Langen Rast austauschen.

**Stufe 1: Göttlicher Orden (Primal Order)**
Wähle eine Option:

* **Gelehrter (Thaumaturge):** Du kennst einen zusätzlichen Kleriker-Zaubertrick. Du erhältst einen Bonus auf Intelligenz-Prüfungen (Religion oder Geschichte) in Höhe deines Weisheitsmodifikators (Minimum +1).
* **Beschützer (Protector):** Du erhältst Übung in Schwerer Rüstung und Kriegswaffen.
...
**Stufe 7: Gesegnete Schläge (Blessed Strikes)**
Wähle eine Option:
* **Göttliche Macht (Divine Strike):** Einmal pro Zug, wenn du eine Kreatur mit einem Waffenangriff triffst, kannst du das Ziel 1W8 extra Nekrotischen oder Gleißenden Schaden (deine Wahl) erleiden lassen.
* **Machtvolles Zauberwirken (Potent Spellcasting):** Addiere deinen Weisheits-Modifikator zum Schaden jedes Kleriker-Zaubertricks.

**Stufe 10: Göttliche Intervention (Divine Intervention)**
Als Magische Aktion kannst du einen beliebigen Kleriker-Zauber der Stufe 5 oder niedriger wählen, der keine Reaktion als Zauberzeit erfordert. Du wirkst diesen Zauber sofort ohne Zauberplatz oder Materialkomponenten. Einmal pro Langer Rast.
...
* **Stufe 3: Domänenzauber:** *Beistand, Segnen, Wunden heilen, Schwächere Genesung, Geistige Waffe, Genesung*.
* **Stufe 3: Jünger des Lebens:** Wenn du einen Zauber der 1. Stufe oder höher wirkst, der TP heilt, erhält das Ziel zusätzliche Heilung in Höhe von `2 + Zauberstufe`.
* **Stufe 6: Bewahrte Vitalität:** Wenn du eine andere Kreatur heilst, heilst du dich selbst um `2 + Zauberstufe` TP.
* **Stufe 17: Höchste Heilung:** Wenn du heilst, würfelst du keine Würfel mehr; nutze stattdessen das Maximum jedes Würfels.
...
* **Stufe 3: Domänenzauber:** *Charme person, Verkleiden, Einflüsterung, Spiegelbilder, Pass ohne Spur, Dimensionstür*.
* **Stufe 3: Segen des Überlisters:** Gib einer Kreatur Vorteil auf Heimlichkeit-Prüfungen für 1 Stunde.
* **Stufe 6: Duplikat beschwören:** Als Bonusaktion (kostet 1x Fokus) ein Trugbild erschaffen. Du kannst daraus Zauber wirken und erhältst Vorteil auf Angriffe, wenn ihr beide beim Ziel steht.
* **Stufe 17: Täuscher-Meister:** Du kannst bis zu 4 Duplikate gleichzeitig führen.
...
* **Primäres Attribut:** Weisheit
* **Trefferwürfel:** W8 pro Druidenstufe
* **Rettungswürfe:** Intelligenz, Weisheit
* **Fertigkeiten (Wähle 2):** Arkanes Wissen, Heilkunde, Mit Tieren umgehen, Motiv erkennen, Nachforschungen (Naturkunde), Religion, Überleben, Wahrnehmung
* **Waffen-Übung:** Einfache Waffen
* **Werkzeug-Übung:** Kräuterkunde-Ausrüstung (Herbalism Kit)
* **Rüstungs-Übung:** Leichte Rüstung, Schilde
* **Startausrüstung:** Wähle A oder B: (A) Lederrüstung, Schild, Sichel, Druidenfokus (Kampfstab), Entdeckerpaket, Kräuterkunde-Ausrüstung und 9 GM; oder (B) 50 GM

### Klassentabelle

| Stufe | Übungsbonus | Merkmale | Tiergestalt (Anw.) | Zaubertricks | Vorbereitete Zauber | 1. | 2. | 3. | 4. | 5. | 6. | 7. | 8. | 9. |
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 1 | +2 | Zauberwirken, Druidisch, Ursprünglicher Orden | 2 | 2 | 4 | 2 | - | - | - | - | - | - | - | - |
| 2 | +2 | Tiergestalt (Wild Shape), Wilder Begleiter | 2 | 2 | 5 | 3 | - | - | - | - | - | - | - | - |
| 3 | +2 | Druiden-Unterklasse | 2 | 2 | 6 | 4 | 2 | - | - | - | - | - | - | - |
| 4 | +2 | Attributswertverbesserung | 2 | 3 | 7 | 4 | 3 | - | - | - | - | - | - | - |
| 5 | +3 | Wilde Wiederbelebung | 2 | 3 | 9 | 4 | 3 | 2 | - | - | - | - | - | - |
| 6 | +3 | Unterklassenmerkmal | 3 | 3 | 10 | 4 | 3 | 3 | - | - | - | - | - | - |
| 7 | +3 | Elementarer Zorn | 3 | 3 | 11 | 4 | 3 | 3 | 1 | - | - | - | - | - |
| 8 | +3 | Attributswertverbesserung | 3 | 3 | 12 | 4 | 3 | 3 | 2 | - | - | - | - | - |
| 9 | +4 | - | 3 | 3 | 14 | 4 | 3 | 3 | 3 | 1 | - | - | - | - |
| 10 | +4 | Unterklassenmerkmal | 3 | 4 | 15 | 4 | 3 | 3 | 3 | 2 | - | - | - | - |
| 11 | +4 | - | 3 | 4 | 16 | 4 | 3 | 3 | 3 | 2 | 1 | - | - | - |
| 12 | +4 | Attributswertverbesserung | 3 | 4 | 16 | 4 | 3 | 3 | 3 | 2 | 1 | - | - | - |
| 13 | +5 | - | 3 | 4 | 17 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | - | - |
| 14 | +5 | Unterklassenmerkmal | 3 | 4 | 17 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | - | - |
| 15 | +5 | Verbesserter Elementarer Zorn | 3 | 4 | 18 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | - |
| 16 | +5 | Attributswertverbesserung | 3 | 4 | 18 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | - |
| 17 | +6 | - | 4 | 4 | 19 | 4 | 3 | 3 | 3 | 2 | 1 | 1 | 1 | 1 |
| 18 | +6 | Bestienzauber | 4 | 4 | 20 | 4 | 3 | 3 | 3 | 3 | 1 | 1 | 1 | 1 |
| 19 | +6 | Epische Wohltat | 4 | 4 | 21 | 4 | 3 | 3 | 3 | 3 | 2 | 1 | 1 | 1 |
| 20 | +6 | Erzdruide | 4 | 4 | 22 | 4 | 3 | 3 | 3 | 3 | 2 | 2 | 1 | 1 |

### Klassenmerkmale

**Stufe 1: Zauberwirken (Spellcasting)**

* Du nutzt Weisheit als Zauberattribut und kannst einen Druidenfokus nutzen. Du bereitest nach einer Langen Rast eine Liste von Druidenzaubern vor (Anzahl siehe Tabelle).

**Stufe 1: Druidisch (Druidic)**

* Du sprichst Druidisch. Du hast den Zauber *Mit Tieren sprechen* immer vorbereitet. Du kannst versteckte Nachrichten in Druidisch hinterlassen (können von Nicht-Druiden nur mit einem Wurf auf Intelligenz (Nachforschung) DC 15 entdeckt, aber ohne Magie nicht entschlüsselt werden).

**Stufe 1: Ursprünglicher Orden (Primal Order)**
Wähle eine der folgenden Optionen:

* **Magier (Magician):** Du kennst einen zusätzlichen Druiden-Zaubertrick. Du erhältst einen Bonus auf Intelligenz-Prüfungen (Arkanes Wissen oder Naturkunde) in Höhe deines Weisheitsmodifikators (Minimum +1).
* **Hüter (Warden):** Du erhältst Übung in Kriegswaffen und Mittlerer Rüstung.

**Stufe 2: Tiergestalt (Wild Shape)**
Als Bonusaktion kannst du dich für eine Anzahl von Stunden in Höhe deiner halben Druidenstufe in eine dir bekannte Bestiengestalt (Beast) verwandeln.

* **Nutzungen:** Du startest mit 2 Nutzungen. Du regenerierst 1 Nutzung bei einer Kurzen Rast und alle Nutzungen bei einer Langen Rast. (Anzahl steigt auf höheren Stufen, siehe Tabelle).
* **Bekannte Gestalten:** Du startest mit 4 bekannten Bestiengestalten. Nach jeder Langen Rast kannst du eine Gestalt gegen eine andere gültige Gestalt austauschen.
* **Tabelle: Bestiengestalten**
* **Stufe 2: 4 bekannte Gestalten, Max. CR: 1/4, Flugbewegungsrate: Nein.**
* **Stufe 4: 6 bekannte Gestalten, Max. CR: 1/2, Flugbewegungsrate: Nein.**
* **Stufe 8: 8 bekannte Gestalten, Max. CR: 1, Flugbewegungsrate: Ja.**


* **Regeln während der Gestalt:** Du behältst deine Intelligenz, Weisheit, Charisma, TP, Trefferwürfel, Übungen und Klassenmerkmale. Du nutzt den höheren Wert, falls das Profil der Bestie bessere Rettungswürfe/Fertigkeiten hat. Du kannst keine Zauber wirken, aber bereits aktive Konzentration aufrechterhalten. Du erhältst bei der Verwandlung **Temporäre Trefferpunkte in Höhe deiner Druidenstufe**. Ausrüstung fällt, verschmilzt (effektlos) oder wird getragen (wenn es der DM als passend erachtet).

**Stufe 2: Wilder Begleiter (Wild Companion)**
Als Magie-Aktion kannst du einen Zauberplatz oder eine Nutzung von *Tiergestalt* ausgeben, um *Vertrauten finden (Find Familiar)* ohne Materialkomponenten zu wirken. Der Vertraute ist vom Typ *Fee (Fey)* und verschwindet, wenn du eine Lange Rast beendest.

**Stufe 3: Druiden-Unterklasse**
Wähle einen Zirkel (siehe unten).

**Stufe 4: Attributswertverbesserung**
Du erhältst ein Talent. Erneut auf Stufe 8, 12 und 16.

**Stufe 5: Wilde Wiederbelebung (Wild Resurgence)**

* Einmal pro Zug (keine Aktion nötig), wenn du keine *Tiergestalt*-Nutzungen mehr hast, kannst du einen Zauberplatz ausgeben, um 1 Nutzung zurückzuerhalten.
* Einmal pro Langer Rast kannst du 1 Nutzung von *Tiergestalt* ausgeben (keine Aktion nötig), um einen Zauberplatz der 1. Stufe zurückzuerhalten.

**Stufe 7: Elementarer Zorn (Elemental Fury)**
Wähle eine Option:

* **Machtvolles Zauberwirken (Potent Spellcasting):** Addiere deinen Weisheitsmodifikator zum Schaden von Druiden-Zaubertricks.
* **Ursprünglicher Schlag (Primal Strike):** Einmal pro Zug, wenn du mit einer Waffe oder einem Angriff in Tiergestalt triffst, fügst du dem Ziel 1W8 zusätzlichen Schaden (Kälte, Feuer, Blitz oder Donner - wähle bei Treffer) zu.
...
Du kannst Zauber wirken, während du in Tiergestalt bist (Ausnahme: Zauber mit Materialkomponenten, die verbraucht werden oder Kosten haben).

**Stufe 19: Epische Wohltat (Epic Boon)**
Wähle ein Talent für Epische Wohltaten.

**Stufe 20: Erzdruide (Archdruid)**

* **Immergrüne Tiergestalt:** Wenn du Initiative würfelst und keine Nutzungen von *Tiergestalt* hast, regenerierst du 1 Nutzung.
* **Naturmagier:** Du kannst nicht-verwendete *Tiergestalt*-Nutzungen in einen einzelnen Zauberplatz umwandeln (2 Zauberstufen pro Nutzung, z.B. 2 Nutzungen = 1 Zauberplatz der 4. Stufe). 1x pro Langer Rast.
* **Langlebigkeit:** Du alterst nur noch 1 Jahr für jeweils 10 vergangene Jahre.



#### Zirkel des Landes (Circle of the Land)

**Stufe 3: Zauber des Zirkels des Landes (Circle Spells)**
Nach einer Langen Rast wählst du einen Landtyp (Arid, Polar, Gemäßigt (Temperate) oder Tropisch). Du hast die entsprechenden Zauber für deine Druidenstufe (und niedriger) immer vorbereitet.

* **Arid:** Stufe 3 (*Verschwimmen, Brennende Hände, Feuerpfeil*), Stufe 5 (*Feuerball*), Stufe 7 (*Dürre*), Stufe 9 (*Steinwand*).
* **Polar:** Stufe 3 (*Nebelwolke, Person festhalten, Kältestrahl*), Stufe 5 (*Eissturm* - *Sleet Storm*), Stufe 7 (*Eissturm* - *Ice Storm*), Stufe 9 (*Kältekegel*).
* **Gemäßigt:** Stufe 3 (*Nebelschritt, Schockgriff, Schlaf*), Stufe 5 (*Blitz*), Stufe 7 (*Bewegungsfreiheit*), Stufe 9 (*Baumschritt*).
...
* Du kannst einen deiner vorbereiteten *Zirkel-Zauber* (Stufe 1+) ohne Zauberplatz wirken. 1x pro Langer Rast.
* Nach einer Kurzen Rast kannst du verbrauchte Zauberplätze regenerieren. Die Summe der Zauberstufen darf höchstens deiner halben Druidenstufe (aufgerundet) entsprechen, keine Plätze über Stufe 5. 1x pro Langer Rast.

**Stufe 10: Schutz der Natur (Nature's Ward)**
...
**Stufe 3: Zirkel-Gestalten (Circle Forms)**
Veränderungen deiner Tiergestalt:

* **Max. Challenge Rating (CR):** Deine Druidenstufe geteilt durch 3 (abgerundet).
* **Rüstungsklasse (AC):** Deine AC ist 13 + Weisheitsmodifikator, falls das höher als die natürliche AC der Bestie ist.
* **Temporäre TP:** Du erhältst Temporäre TP in Höhe deiner Druidenstufe x 3.

**Stufe 3: Zauber des Zirkels des Mondes**
Du hast folgende Zauber immer vorbereitet und kannst sie wirken, während du in Tiergestalt bist:

* Stufe 3: *Wunden heilen, Mondstrahl, Sternenlicht-Irrwisch (Starry Wisp)*
* Stufe 5: *Tiere beschwören*
* Stufe 7: *Quell des Mondlichts (Fount of Moonlight)*
* Stufe 9: *Massen-Wunden heilen*

**Stufe 6: Verbesserte Zirkel-Gestalten (Improved Circle Forms)**
In Tiergestalt:

* Jeder deiner Angriffe kann statt dem normalen Schaden Gleißenden Schaden (Radiant) verursachen.
...
**Stufe 3: Zauber des Zirkels des Meeres**
Folgende Zauber sind immer vorbereitet:

* Stufe 3: *Nebelwolke, Windstoß, Kältestrahl, Klirren (Shatter), Donnerwoge*
* Stufe 5: *Blitz, Wasseratmen*
* Stufe 7: *Wasser formen, Eissturm*
...
Während *Zorn des Meeres* aktiv ist, erhältst du:

* Eine Flugbewegungsrate in Höhe deiner normalen Bewegungsrate.
...
**Stufe 3: Sternenkarte (Star Map)**
Du erhältst einen Winzigen (Tiny) Fokus.

* Du hast *Leitung (Guidance)* und *Lenkendes Geschoss (Guiding Bolt)* immer vorbereitet.
* Du kannst *Lenkendes Geschoss* ohne Zauberplatz wirken (Nutzungen = Weisheitsmodifikator pro Langer Rast).
...
Während die Sternengestalt aktiv ist, hast du Resistenz gegen Wucht-, Stich- und Schnittschaden.
...
### Kernmerkmale
* **Primäre Attribute:** Geschicklichkeit und Weisheit
* **Trefferwürfel (Hit Point Die):** W10 pro Waldläufer-Stufe
* **Rettungswurf-Übungsbonus (Saving Throw Proficiencies):** Stärke und Geschicklichkeit
...
**Stufe 1: Zauberwirken (Spellcasting)**
* **Zauberplätze (Spell Slots):** Du erhältst Zauberplätze der Stufen 1 und höher, beginnend ab Stufe 1. Nach einer Langen Rast erhältst du alle verbrauchten Zauberplätze zurück.
* **Vorbereitete Zauber (Prepared Spells):** Du beginnst mit 2 vorbereiteten Waldläufer-Zaubern der Stufe 1. Die Anzahl steigt mit deiner Stufe. Bei jedem Stufenaufstieg kannst du einen vorbereiteten Zauber durch einen anderen Waldläufer-Zauber der passenden Stufe austauschen. Du kannst einen Druidischen Fokus verwenden.
...
**Stufe 1: Waffenmeisterschaft (Weapon Mastery)**
* Du wählst zwei Arten von Waffen aus (z. B. Langbogen und Kurzschwert), für die du Übung hast. Du kannst die Meisterschafts-Eigenschaften (Mastery Properties) dieser Waffen nutzen.
...
**Stufe 3: Waldläufer-Archetyp (Ranger Archetype)**
* Wähle eine Unterklasse aus (siehe unten). Du erhältst Merkmale dieser Unterklasse auf den Stufen 3, 7, 11 und 15.

**Stufe 4: Attributswertverbesserung (Ability Score Improvement)**
* Du erhältst ein Talent deiner Wahl. Geschieht erneut auf den Stufen 8, 12 und 16.
...
**Stufe 9: Expertise**
* Wähle zwei weitere deiner Waldläufer-Fertigkeiten aus, für die dein Übungsbonus verdoppelt wird.

**Stufe 10: Unermüdlich (Tireless)**
* **Temporäre Trefferpunkte:** Als Magische Aktion kannst du dir selbst 1W8 + dein Weisheits-Modifikator temporäre Trefferpunkte geben. Du kannst dies in Höhe deines Übungsbonus tun und erhältst alle Anwendungen nach einer Langen Rast zurück.
* **Erschöpfung lindern:** Wenn du eine Kurze Rast beendest, reduziert sich deine Erschöpfung (Exhaustion) um 1 Stufe.
...
**Stufe 20: Schlächter der Feinde (Foe Slayer)**
* Der Bonusschaden deines *Zeichen des Jägers* wird zu 1W10 (anstatt 1W6).
...
### Kernmerkmale
* **Primäres Attribut:** Charisma
* **Trefferwürfel (Hit Point Die):** W6 pro Zauberer-Stufe
* **Rettungswurf-Übungsbonus (Saving Throw Proficiencies):** Konstitution und Charisma
* **Fertigkeiten (Skill Proficiencies):** Wähle 2 aus: Arkane Kunde (Arcana), Täuschen (Deception), Motiv erkennen (Insight), Einschüchtern (Intimidation), Überreden (Persuasion) oder Religion
* **Waffen-Übungsbonus (Weapon Proficiencies):** Einfache Waffen (Simple Weapons)
* **Rüstungstraining (Armor Training):** Keine
* **Startausrüstung:** Wähle A oder B: (A) Speer, 2 Dolche, Arkaner Fokus (Kristall), Gewölbeforscher-Ausrüstung und 28 GM; oder (B) 50 GM

### Klassenmerkmale

**Stufe 1: Zauberwirken (Spellcasting)**
* **Zaubertricks (Cantrips):** Du kennst zu Beginn 2 Zaubertricks deiner Wahl aus der Zauberer-Zauberliste. Auf den Stufen 4 und 10 erlernst du jeweils einen weiteren Zaubertrick. Bei jedem Stufenaufstieg als Zauberer kannst du einen Zaubertrick austauschen.
* **Zauberplätze (Spell Slots):** Du erhältst Zauberplätze der Stufen 1 und höher, deren Anzahl sich mit deinem Zauberer-Level erhöht. Nach einer Langen Rast erhältst du alle verbrauchten Zauberplätze zurück.
* **Vorbereitete Zauber (Prepared Spells):** Du beginnst mit 2 vorbereiteten Zauberer-Zaubern der Stufe 1. Die Anzahl steigt mit deiner Stufe. Bei jedem Stufenaufstieg kannst du einen vorbereiteten Zauber durch einen anderen Zauberer-Zauber der passenden Stufe austauschen.
* **Zauberattribut:** Charisma.
* **Zauber-Rettungswurf-SG:** 8 + dein Charisma-Modifikator + dein Übungsbonus.
* **Zauber-Angriffsbonus:** Dein Charisma-Modifikator + dein Übungsbonus.
* **Zauberfokus:** Du kannst einen Arkanen Fokus verwenden.

**Stufe 1: Innere Magie (Innate Sorcery)**
* Als Bonusaktion kannst du deine Magie für 1 Minute entfesseln. 
* Du erhältst folgende Vorteile: Der Rettungswurf-SG deiner Zauberer-Zauber erhöht sich um 1. Du hast Vorteil auf Angriffswürfe deiner Zauberer-Zauber.
* Du kannst dieses Merkmal zweimal verwenden und erhältst alle verbrauchten Anwendungen nach einer Langen Rast zurück.

**Stufe 2: Quelle der Magie (Font of Magic)**
* Du hast 2 Zaubereipunkte (Sorcery Points), und die maximale Anzahl entspricht deiner Zauberer-Stufe. Nach einer Langen Rast erhältst du alle Punkte zurück.
* **Zauberplätze umwandeln:** Du kannst einen Zauberplatz aufwenden, um Zaubereipunkte in Höhe des Zauberplatz-Levels zu erhalten.
* **Zauberplätze erschaffen:** Als Bonusaktion kannst du Zaubereipunkte in einen Zauberplatz (maximal Stufe 5) umwandeln. Kosten: Stufe 1 = 2 Punkte, Stufe 2 = 3 Punkte, Stufe 3 = 5 Punkte, Stufe 4 = 6 Punkte, Stufe 5 = 7 Punkte. Erschaffene Plätze verschwinden nach einer Langen Rast.

**Stufe 2: Metamagie (Metamagic)**
* Du wählst 2 Metamagie-Optionen aus. Auf Stufe 10 und Stufe 17 erhältst du jeweils zwei weitere.
* Bei jedem Stufenaufstieg kannst du eine Option austauschen.
* **Metamagie-Optionen:**
  ...
  * **Umgeformter Zauber (Transmuted Spell):** 1 Punkt. Wandle den Schadenstyp in Säure, Kälte, Feuer, Blitz, Gift oder Donner um.
  * **Verstärkter Zauber (Empowered Spell):** 1 Punkt. Würfle Schadenswürfel (bis zu deinem Charisma-Modifikator, mind. 1) neu und verwende das neue Ergebnis. Kann mit einer anderen Metamagie kombiniert werden.
  * **Zwillingszauber (Twinned Spell):** 1 Punkt. Wenn der Zauber durch das Verwenden eines höheren Zauberplatzes ein zusätzliches Ziel erfassen kann, erhöht dieser Punkt das effektive Level des Zaubers um 1.

**Stufe 3: Zauberer-Unterklasse (Sorcerer Subclass)**
* Wähle eine Unterklasse (siehe unten). Diese verleiht weitere Merkmale auf den Stufen 3, 6, 14 und 18.

**Stufe 4: Attributswertverbesserung (Ability Score Improvement)**
* Du erhältst ein Talent deiner Wahl. Geschieht erneut auf den Stufen 8, 12 und 16.

**Stufe 5: Zauberhafte Wiederherstellung (Sorcerous Restoration)**
* Bei Abschluss einer Kurzen Rast kannst du Zaubereipunkte in Höhe der Hälfte deiner Zauberer-Stufe (abgerundet) zurückerhalten. Einmal pro Langer Rast.

**Stufe 7: Verkörperte Zauberei (Sorcery Incarnate)**
* Wenn du keine Anwendungen von *Innere Magie* mehr hast, kannst du als Teil der Bonusaktion 2 Zaubereipunkte ausgeben, um es trotzdem zu aktivieren.
* Während *Innere Magie* aktiv ist, kannst du bis zu zwei Metamagie-Optionen auf den gleichen Zauber anwenden.

**Stufe 19: Epischer Segen (Epic Boon)**
* Du erhältst ein Epischer Segen-Talent.

**Stufe 20: Arkane Apotheose (Arcane Apotheosis)**
* Während *Innere Magie* aktiv ist, kannst du eine Metamagie-Option in jedem deiner Züge anwenden, ohne dafür Zaubereipunkte auszugeben.
...
| 13 | +5 | Mystisches Arkanum (Stufe 7) | 6 | 4 | 12 | 3 | 5 |
| 14 | +5 | Unterklassenmerkmal | 6 | 4 | 12 | 3 | 5 |
| 15 | +5 | Mystisches Arkanum (Stufe 8) | 7 | 4 | 13 | 3 | 5 |
...
**Stufe 1: Paktmagie (Pact Magic)**

* **Zauberplätze:** Du regenerierst alle verbrauchten Paktmagie-Zauberplätze bei Abschluss einer Kurzen oder Langen Rast. Alle Plätze haben dieselbe, skalierende Stufe (siehe Tabelle).
* **Vorbereitete Zauber:** Du wählst Zauber der 1. Stufe oder höher aus der Hexenmeister-Liste (Anzahl siehe Tabelle). Wenn die Anzahl steigt, dürfen neue Zauber keine höhere Stufe haben als deine aktuelle "Platz-Stufe". Beim Stufenaufstieg kannst du einen Zauber austauschen.
* **Zauberattribut:** Charisma.
* **Fokus:** Arkaner Fokus.
...
### Liste: Schauerliche Anrufungen (Eldritch Invocations)
...
**Stufe 14: Verhexende Magie (Bewitching Magic)**
Wirkst du einen Verzauberungs- oder Illusionszauber (als Aktion mit Zauberplatz), kannst du als Teil der Aktion *Nebelschritt* kostenlos wirken.
...
* Stufe 3: *Brennende Hände, Befehl, Sengender Strahl, Einflüsterung*
* Stufe 5: *Feuerball, Stinkende Wolke*
...
* Stufe 3: *Gedanken wahrnehmen, Misstönendes Flüstern, Phantasmagorische Kraft, Tashas fürchterlicher Lachanfall*
* Stufe 5: *Hellsehen, Hadars Hunger*
* Stufe 7: *Verwirrung, Aberration beschwören*
* Stufe 9: *Erinnerung verändern, Telekinese*

**Stufe 3: Psychische Zauber (Psychic Spells)**
Du kannst den Schaden von Hexenmeister-Schadenszaubern in Psychischen Schaden umwandeln. Wirkst du Verzauberungs- oder Illusionszauber der Klasse, entfallen die verbalen und somatischen Komponenten.
