# Kapitel 4: Herkunft (Origins)

Deine Herkunft wird durch deinen Hintergrund (Background) und deine Spezies (Species) definiert. Diese mechanischen Bausteine bestimmen deine Start-Attribute, deine ersten Talente sowie grundlegende physiologische und gelernte Fähigkeiten.

---

## 1. Hintergründe (Backgrounds)

Dein Hintergrund legt drei Attributswerte fest, die du erhöhen kannst (entweder ein Attribut um +2 und ein weiteres um +1, oder alle drei um +1). Außerdem gewährt er dir ein festgelegtes Herkunfts-Talent (Origin Feat), zwei Fertigkeits-Übungsboni (Skill Proficiencies) und einen Werkzeug-Übungsbonus (Tool Proficiency). 

### Hintergrund-Tabelle

| Hintergrund (Background) | Attributs-Optionen | Herkunfts-Talent | Fertigkeiten (Skills) | Werkzeug (Tool) |
| :--- | :--- | :--- | :--- | :--- |
| **Akolyth (Acolyte)** | INT, WEI, CHA | Magie-Initiat (Kleriker) | Motiv erkennen, Religion | Kalligrafen-Zubehör |
| **Adliger (Noble)** | STR, INT, CHA | Geübt (Skilled) | Geschichte, Überreden | Ein Spielset |
| **Bauer (Farmer)** | STR, KON, WEI | Zäh (Tough) | Mit Tieren umgehen, Naturkunde | Zimmerwerkzeug |
| **Einsiedler (Hermit)** | KON, WEI, CHA | Heiler (Healer) | Heilkunde, Religion | Kräuterkunde-Ausrüstung |
| **Führer (Guide)** | GES, KON, WEI | Magie-Initiat (Druide) | Heimlichkeit, Überleben | Kartografen-Werkzeug |
| **Gelehrter (Sage)** | KON, INT, WEI | Magie-Initiat (Magier) | Arkane Kunde, Geschichte | Kalligrafen-Zubehör |
| **Handwerker (Artisan)** | STR, GES, INT | Handwerker (Crafter) | Nachforschen, Überreden | Ein Handwerkszeug |
| **Händler (Merchant)** | KON, INT, CHA | Glückspilz (Lucky) | Mit Tieren umgehen, Überreden | Navigatoren-Werkzeug |
| **Krimineller (Criminal)** | GES, KON, INT | Wachsam (Alert) | Fingerfertigkeit, Heimlichkeit | Diebeswerkzeug |
| **Reisender (Wayfarer)** | GES, WEI, CHA | Glückspilz (Lucky) | Motiv erkennen, Heimlichkeit | Diebeswerkzeug |
| **Scharlatan (Charlatan)** | GES, KON, CHA | Geübt (Skilled) | Täuschen, Fingerfertigkeit | Fälscher-Ausrüstung |
| **Schreiber (Scribe)** | GES, INT, WEI | Geübt (Skilled) | Nachforschen, Wahrnehmung | Kalligrafen-Zubehör |
| **Seefahrer (Sailor)** | STR, GES, WEI | Tavernenschläger | Akrobatik, Wahrnehmung | Navigatoren-Werkzeug |
| **Soldat (Soldier)** | STR, GES, KON | Wilder Angreifer | Athletik, Einschüchtern | Ein Spielset |
| **Unterhalter (Entertainer)**| GES, KON, CHA | Musiker (Musician) | Akrobatik, Auftreten | Ein Musikinstrument |
| **Wache (Guard)** | STR, INT, WEI | Wachsam (Alert) | Athletik, Wahrnehmung | Ein Spielset |

*(Zusätzlich erhält jeder Hintergrund Ausrüstung im Wert von 50 GM oder pauschal 50 GM, um eigene Startausrüstung zu kaufen.)*

---

## 2. Spezies (Species)

Alle Spezies haben als Kreaturentyp "Humanoid". Spezies gewähren in den 2024-Regeln **keine** Attributsverbesserungen mehr.
...
* **Drachenflug (Stufe 5):** Als Bonusaktion wachsen Flügel für 10 Minuten (Fluggeschwindigkeit = Laufgeschwindigkeit). (1x pro Langer Rast).
...
* **Gnom-Abstammung:** Wähle eine Abstammung (Zauberattribut ist INT, WEI oder CHA):
  ...
  * *Waldgnom:* Du kennst *Kleine Illusion*. Du kannst *Tiere besprechen* beliebig oft wirken, ohne Zauberplätze zu nutzen.
...
* **Riesige Abstammung:** Wähle eine Art (Nutzungen = Übungsbonus pro Langer Rast):
  ...
  * *Steinriese:* Reaktion (wenn getroffen im Nahkampf): Angreifer macht STR-Save oder erleidet 1W12 Wuchtschaden und wird Prone (Liegend).
  * *Sturmriese:* Reaktion (wenn getroffen): Angreifer erleidet 1W8 Blitzschaden.
...
* **Heimlichkeit von Natur aus:** Übung in Heimlichkeit (Stealth). Verstecken hinter Kreaturen möglich, die mind. eine Größe größer sind.
...
* **Teuflisches Erbe:** Wähle ein Erbe (Zauberattribut ist INT, WEI oder CHA):
  ...
  * *Chthonisch:* Resistenz gegen Nekrotischen Schaden. Zauber: *Gefrierende Berührung* (Stufe 1), *Falsches Leben* (Stufe 3), *Schwächungsstrahl* (Stufe 5).
  * *Infernalisch:* Resistenz gegen Feuerschaden. Zauber: *Feuerpfeil* (Stufe 1), *Höllischer Tadel* (Stufe 3), *Dunkelheit* (Stufe 5).
