    ...
    fun getCharacter(id: String): CharacterData {
        return when (id) {
            ...
            "Delat" -> CharacterData(
                ...
                defaultTraits = listOf(
                    TraitItem("Dunkelsicht (36m)", "Du kannst in Dunkelheit sehen."),
                    TraitItem("Steingespür", "Bonusaktion. Erschütterungssinn für 10 min innerhalb von 18m, wenn beide auf Gestein.", maxUses = 3, currentUses = 3),
                    ...
                    TraitItem("Paktmagie", "2 Zauberplätze (St. 3), 6 vorbereitete Zauber, 3 Zaubertricks."),
                    TraitItem("Pakt der Klinge - Paktwaffe", "Beschwöre magische Waffe (BA). Kann als arkaner Fokus genutzt werden. Ermöglicht extra Angriff ab Level 5."),
